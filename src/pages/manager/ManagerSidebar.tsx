    ...
    <>
      ...
      `}>
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          {/* New Feature: Workload Balancer */}
          <button
            onClick={() => onViewChange('workload-balancer')}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
              activeView === 'workload-balancer' 
                ? 'bg-blue-50 text-blue-700 border border-blue-200' 
                : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
            }`}
          >
            <Zap className="h-5 w-5" />
            <span className="font-medium">Workload Balancer</span>
          </button>

          {/* New Feature: Skill Recommendations */}
          <button
            onClick={() => onViewChange('skill-recommendations')}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
              activeView === 'skill-recommendations' 
                ? 'bg-blue-50 text-blue-700 border border-blue-200' 
                : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
            }`}
          >
          ...
          {/* New Feature: Team Collaboration Notes */}
          <button
            onClick={() => onViewChange('team-notes')}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
              activeView === 'team-notes' 
                ? 'bg-blue-50 text-blue-700 border border-blue-200' 
                : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
            }`}
          >
